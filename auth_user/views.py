...
from .serializers import  ShopUserRegistrationSerializers,UserLoginSerializer, ShopUserAccountSerializers, UserAddressSerializers
...
class ShopUserViewSet(viewsets.ModelViewSet):
    ...
    serializer_class = ShopUserAccountSerializers
...
class ShopUserRegistrationViewSet(APIView):
    serializer_class = ShopUserRegistrationSerializers
    ...
    def post(self,request):
        ...
        if serializer.is_valid(): # json data valid hoile er condition e jabe
            ...
            print("uid ", uid)
            confirm_link = f"http://127.0.0.1:8000/auth_user/active/{uid}/{token}"
